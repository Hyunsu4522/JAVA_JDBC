...
//Controller : View를 통해서 사용자가 요청한 기능에 대해서 처리하느 ㄴ담당
...
public class MemberController {
	...
	public void selectByUserId(String userId) {
		...
		if(m == null) {
			new MemberMenu().displayNoData(userId + "해당하는 조회 결화가 없습니다.");
		}else {
	...
	public void deleteMember(String userId) {
		...
		if(result > 0) {
			new MemberMenu().displaySuccess(userId + "회원 성공적으로 삭제하였습니다.");
		}else {
